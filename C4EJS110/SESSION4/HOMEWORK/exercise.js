...
function ex3Answer() {
    console.clear();
    console.log("3.1. The data tyte of the outermost layer is object.")
    console.log("3.2. It is a array.");
...
//5.5. Search the products based on the wanted provider entered by users, if you need more directions, find the hints at the end of this homework//
...
function ex55() {
    ...
    products[2].Providers = ['Tgdd'];
    products[3].Providers = ['Tgdd'];
    let groupProductsByProviders = {};
    for (let x of products) {
        for (let y in x.Providers) {
            if (groupProductsByProviders[x.Providers[y].toLowerCase()] == undefined) {
                groupProductsByProviders[x.Providers[y].toLowerCase()] = [];
                groupProductsByProviders[x.Providers[y].toLowerCase()].push(x);
            }
            else {
                groupProductsByProviders[x.Providers[y].toLowerCase()].push(x);
            }
    ...
    if (groupProductsByProviders[provider] != undefined) {
        for (let i in groupProductsByProviders[provider]) {
            console.log('-----------------------------------');
            for (let j in groupProductsByProviders[provider][i]) {
                console.log(`${j}: ${groupProductsByProviders[provider][i][j]}`);
            }
        }
    }
    else{
        console.log(`Have not product provider is ${provider}`);
    }
}
...
function ex61() {
    ...
    for (let i in learningFrontEndDev) {
        console.log(`${Number(i) + 1}. ${learningFrontEndDev[i].Task}`);
        console.log(`   Complete: ${learningFrontEndDev[i].Complete}`);
    }
}
...
//6.5. Let users delete task (No illustrative image, you already know the drill)
...
function ex66() {
    for (let i in learningFrontEndDev) {
        if (learningFrontEndDev[i].Complete) {
            learningFrontEndDev[i].Complete = '[x]';
        }
        else {
            learningFrontEndDev[i].Complete = '[ ]';
        }
    }
    let check = true;
    while (check) {
        printListLearing();
        let choose = prompt("Enter your command(New, Delete, Update, Complete)").toLowerCase();
        switch (choose) {
            case "new": {
                let newTask = prompt("Enter new task");
                learningFrontEndDev.push({ Task: newTask, Complete: '[ ]' });
                break;
            }
            case 'delete': {
                let posDel = Number(prompt("Enter position:"));
            ...
            case 'complete': {
                let posComplete = Number(prompt("Enter position:"));
                learningFrontEndDev[posComplete - 1].Complete = '[x]';
                break;
            }
            default: {
...
function ex155() {
    ...
    for (let x of jobData.hits[0].benefits) {
        console.log(`- ${x.benefitValue}`);
    }
}
...
function ex156() {
    console.clear();
    for (let x of jobData.hits) {
        console.log(x.jobTitle);
        console.log("Benefits:");
        for (let y of x.benefits) {
            console.log(`- ${y.benefitValue}`);
        }
        console.log('------------------------------------------------------');
    }
}
...
function ex157() {
    console.clear();
    for (let x of jobData.hits) {
        console.log(`Title: ${x.jobTitle}`);
        console.log(`Salary: ${x.jobSalary}$`);
