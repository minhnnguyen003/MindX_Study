...
import { getNewTime } from "./utils.js";
        ...
        this.shadow.getElementById("button_add").addEventListener("click", () => {
            ...
            if(name == "" || age == "") {
                ...
                firebase.firestore().collection("employees").add({name, age, image, create : getNewTime()}).then((res) => {
                    ...
                    document.querySelector("main-screen").shadowRoot.getElementById("employee_content").insertAdjacentHTML('beforeend', newEmployee.show());
